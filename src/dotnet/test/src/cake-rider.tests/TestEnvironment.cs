...
[ZoneDefinition]
public interface IFrostingTestsEnvZone : ITestsEnvZone
{
}

[ZoneDefinition]
public interface IFrostingTestsZone : IZone, IRequire<PsiFeatureTestZone>
{
}

// Activates the zones required for tests. Cannot be in the same namespace as a requirement for a zone it activates!
[ZoneActivator]
[ZoneMarker(typeof(IFrostingTestsEnvZone))]
public class FrostingTestsZoneActivator : IActivate<IFrostingTestsZone>
{
}

[SetUpFixture]
public class TestEnvironment : ExtensionTestEnvironmentAssembly<IFrostingTestsEnvZone>
{
